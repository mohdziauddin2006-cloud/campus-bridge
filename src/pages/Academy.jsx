...
export default function Academy() {
  ...
  return (
    <main className="bg-slate-50 min-h-screen pb-20 pt-6 px-6 lg:px-10 max-w-6xl mx-auto">
      <h1 className="text-3xl font-extrabold text-slate-950 mb-2">Video Academy</h1>
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        {categories.map(c => (
          <button
            ...
            className={`px-3 py-1.5 rounded-full text-sm font-bold transition border ${
              filterCat === c
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-3">
          ...
          {filtered.map(v => (
            ...
            >
              <h4 className="font-extrabold text-slate-950">{v.title}</h4>
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-8">
            <h3 className="text-2xl font-extrabold text-slate-950 mb-2">{activeVideo.title}</h3>
            ...
            <h4 className="font-bold text-slate-950 mb-2">Key Takeaways</h4>
