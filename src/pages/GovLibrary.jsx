...
export default function GovLibrary() {
  return (
    <main className="bg-[#0b0d12] min-h-screen pb-20 pt-6 px-6 lg:px-10">
      <h1 className="text-4xl font-extrabold text-slate-900 mb-2">Government Resource Library</h1>
      <p className="text-slate-700 text-[15px] font-medium leading-relaxed mb-10">Open, free, and authoritative Indian education portals.</p>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {resources.map(r => (
          ...
          >
            ...
            <p className="text-slate-700 text-[15px] font-medium leading-relaxed mb-3">{r.desc}</p>
